...
#pragma region GetObjects
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToMemory(const FString& InBucketName,const FString& InObjectName,FRange Range,ProgressCallback InProgressCallback,OnceStringCallBack StartCallback,TFunction<void(ANSICHAR*, int32)> Fun);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToMemory(const FString& InBucketName, const FString& InObjectName, TArray<uint8>& OutData, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack StartCallback = nullptr, OnceByteCallBack EndCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToMemoryByURL(const FString& URL, TArray<uint8>& DataBytes, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack StartCallback = nullptr, OnceByteCallBack EndCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		bool GetObjectToMemoryByURL(const FString& URL,FRange Range, ProgressCallback InProgressCallback, OnceStringCallBack StartCallback, TFunction<void(ANSICHAR*, int32)> Fun);
...
#pragma region Async
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		void AsyncPutObjectByMemory(const FString& InBucketName, const FString& InObjectName, const TArray<uint8>& Data, ProgressCallback InProgressCallback = nullptr, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>());
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		void AsyncPutObjectMemoryByURL(const FString& URL, const TArray<uint8>& Data, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		void AsyncGetObjectToMemory(const FString& InBucketName, const FString& InObjectName, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceByteCallBack InEndCallback = NULL);
		...
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		*/
		void AsyncGetObjectToMemoryByURL(const FString& URL, FRange Range = FRange(), ProgressCallback InProgressCallback = nullptr, OnceStringCallBack InStartCallback = NULL, OnceByteCallBack InEndCallback = NULL);
...
#pragma region PutObject
		...
		*/
		...
		/**
		* Upload resources memory by string
		* @ InBucketName			Bucket name
		* @ Data					Data to upload, which exists in memory.
		* @ InObjectName			Object name
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		...
		*/
		...
		/**
		* Upload resources memory by byte
		* @ InBucketName			Bucket name
		* @ Data					Data to upload, which exists in memory.
		* @ InObjectName			Object name
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectByMemory(const FString& InBucketName, const FString& InObjectName, const TArray<uint8>& InData, ProgressCallback InProgressCallback = nullptr, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>());

		/**
		* Upload resources memory by size
		* @ InBucketName			Bucket name
		* @ Data					Data to upload, which exists in memory.
		* @ InObjectName			Object name
		* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectByMemory(const FString& InBucketName, const FString& InObjectName, const void* InData,int32 InSize, ProgressCallback InProgressCallback = nullptr, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>());
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectMemoryByURL(const FString& URL, const TArray<uint8>& Data, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
		...
		* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
		*/
		bool PutObjectMemoryByURL(const FString& URL, const void* Data,int32 DataSize, const TMap<FString, FString>& OSSMeta = TMap<FString, FString>(), ProgressCallback InProgressCallback = nullptr);
